...
public class Register{
    public Register() {
        ...
        JLabel pz = new JLabel("Confirm");
        pw.setBounds(150, 150, 200, 30);
        pz.setBounds(10, 150, 200, 30);
        ...
        s1.addActionListener(new ActionListener() {
                                 ...
                                 public void actionPerformed(ActionEvent e1) {
                                     ...
                                     new joe(un1.getText(), pwd.getText(), gender.getText());
        ...
        s1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e8) {
                ...
                try {
                    FileOutputStream fileOut = new FileOutputStream("C:\\Users\\HP\\Downloads\\CabSharing\\New folder\\user1.ser");
